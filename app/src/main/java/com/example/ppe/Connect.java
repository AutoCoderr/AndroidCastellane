...
public class Connect extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btConnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Controleur controleur = new Controleur(Connect.this, Connect.this);
                controleur.sendConnect(prenom, nom, password);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_connect) {
            ...
            Intent i = new Intent(Connect.this, Register.class);
            startActivity(i);
        } else if (id == R.id.nav_presentation) {
            Intent i = new Intent(Connect.this, MainActivity.class);
            startActivity(i);
        } else if (item.getTitle() == "Rendez-vous") {
            Intent i = new Intent(Connect.this, ListRendezVous.class);
            startActivity(i);
        } else if (item.getTitle() == "Diplomes") {
            Intent i = new Intent(Connect.this, Diplomes.class);
            startActivity(i);
        } else if (item.getTitle() == "Mes infos") {
            Intent i = new Intent(Connect.this, Fiche.class);
            startActivity(i);
        } else if (item.getTitle() == "Administration") {
            Intent i = new Intent(Connect.this, Admin.class);
            startActivity(i);
        }
